...
class AddForeignKeysToTransfersTable extends Migration {
	...
	public function up()
	{
		Schema::table('transfers', function(Blueprint $table)
		{
			...
			// $table->foreignId('from_warehouse_id')->nullable()->constrained('warehouses')->cascadeOnDelete()->cascadeOnUpdate();
			// $table->foreignId('to_warehouse_id')->nullable()->constrained('warehouses')->cascadeOnDelete()->cascadeOnUpdate();
