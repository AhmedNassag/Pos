...
class AddForeignKeysToProductsTable extends Migration {
	...
	public function up()
	{
		Schema::table('products', function(Blueprint $table)
		{
			...
			// $table->foreignId('unit_sale_id')->nullable()->constrained('units')->cascadeOnDelete()->cascadeOnUpdate();
			// $table->foreignId('unit_purchase_id')->nullable()->constrained('units')->cascadeOnDelete()->cascadeOnUpdate();
		});
	}
