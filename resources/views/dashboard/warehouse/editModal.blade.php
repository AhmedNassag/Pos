    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- Form -->
                <form action="{{ route('warehouses.update', 'test') }}" method="post" enctype="multipart/form-data">
                    {{ method_field('patch') }}
                    @csrf
                    <div class="row">
                        <!-- name -->
                        ...
                        <!-- phone -->
                        <div class="col-6">
                            <label for="mobile" class="mr-sm-2">{{ trans('main.Phone') }} :</label>
                            <input id="mobile" type="text" class="form-control" name="mobile" value="{{ $item->mobile }}">
                        </div>
                        <!-- country -->
                        <div class="col-6">
