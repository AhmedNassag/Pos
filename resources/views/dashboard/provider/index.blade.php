    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ trans('main.Providers') }}</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
...
@section('content')
        ...
        <div class="row">
                    ...
                    <div id="print">
                        <div class="card-header pb-0">
                            ...
                            <div class="d-flex justify-content-between">
                                <h4 class="card-title mg-b-0">{{ trans('main.Providers') }}</h4>
                            ...
                            <div class="row row-xs">
                                <div class="col-sm-6 col-md-12 notPrint">
                                    @if($trashed == false)
                                        ...
                                        @endcan
                                        @can('أرشيف الموردين')
                                            <a class="btn btn-danger ripple float-left" href="{{ route('providers.archived') }}">
                                                <i class="fe fe-alert-triangle"></i>&nbsp;{{ trans('main.Archive') }} {{ trans('main.Providers') }}
                                            </a>
                                        @endcan
                                    @else
                                        @can('عرض الموردين')
                                            <a class="btn btn-danger ripple float-left" href="{{ route('providers.index') }}">
                                ...
                                <table class="table table-striped" id="example1" data-page-length='50' style=" text-align: center;">      
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($providers as $item)
                                                ...
                                                <td class="text-center notPrint">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu tx-13 bd-primary rounded-5">
                                                            @if($trashed == false)
                                                                @can('عرض الموردين')
                                                                    <a class="dropdown-item" href="{{ route('providers.show',[$item->id]) }}" title="{{ trans('main.Show') }}">
                                            ...
                                            @include('dashboard.provider.editModal')
                                            @include('dashboard.provider.deleteModal')
                                            @include('dashboard.provider.forceDeleteModal')
                                            @include('dashboard.provider.restoreModal')
            ...
            @include('dashboard.provider.addModal')
            @include('dashboard.provider.deleteSelectedModal')
