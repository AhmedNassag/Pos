...
@section('css')
    @section('title')
    {{ trans('main.Returns') }} {{ trans('main.Purchases') }}
    @stop
@endsection
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ trans('main.Returns') }} {{ trans('main.Purchases') }}</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
...
@section('content')
        ...
        <div class="row">
                    ...
                    <div id="print">
                        <div class="card-header pb-0">
                            ...
                            <div class="d-flex justify-content-between">
                                <h4 class="card-title mg-b-0">{{ trans('main.Returns') }} {{ trans('main.Purchases') }}</h4>
                                    ...
                                    <tbody>
                                        ...
                                        @if($trashed == false)
                                            <tr class="notPrint">
                                                ...
                                                <td class="text-center"></td>
                                                <form action="{{ route('purchasesReturns.index') }}" method="get">
                                        ...
                                        <!-- end serch -->
                                        <?php $i = 0; ?>
                                        @foreach ($purchasesReturns as $item)
                                            <?php $i++; ?>
                                            <tr>
                                                @if($trashed == false)
                                                ...
                                                <td class="text-center notPrint">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu tx-13 bd-primary rounded-5">
                                                            @if($trashed == false)
                                                                @can('عرض مرتجع المشتريات')
                                                                    <a class="dropdown-item" href="{{ route('purchasesReturns.show',[$item->id]) }}" title="{{ trans('main.Show') }}">
                                                                        <i class="text-success fas fa-eye"></i>&nbsp;&nbsp;{{ trans('main.Show') }}
                                                                    </a>
                                                                @endcan
                                                                @can('عرض دفع مرتجع المشتريات')
                                            ...
                                            @include('dashboard.purchaseReturn.deleteModal')
                                            @include('dashboard.purchaseReturn.forceDeleteModal')
                                            @include('dashboard.purchaseReturn.restoreModal')
                                            @include('dashboard.purchaseReturn.addPaymentModal')
                                            @include('dashboard.purchaseReturn.showPaymentsModal')
            ...
            @include('dashboard.purchaseReturn.addModal')
            @include('dashboard.purchaseReturn.deleteSelectedModal')
