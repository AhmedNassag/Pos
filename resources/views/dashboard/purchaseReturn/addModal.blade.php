	...
	<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
		<div class="modal-content modal-content-demo">
            ...
            <div class="modal-body">
                <!-- Form -->
                <form method="POST" action="{{ route('purchasesReturns.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <!-- date -->
                        <div class="col-4">
                        ...
                        <div class="col-4">
                            ...
                            <input id="discount" type="number" class="form-control" name="discount" value="0" value="{{ old('discount') }}" value="0" required oninput="checkDiscount()">
                        </div>
                        <!-- shipping -->
                        <div class="col-4">
                            <label for="shipping" class="mr-sm-2">{{ trans('main.Shipping') }} :</label>
                            <input id="shipping" type="number" class="form-control" name="shipping" value="0" value="{{ old('shipping') }}" value="0" required oninput="checkShipping()">
                        </div>
                        <!-- status -->
                        <div class="col-4">
