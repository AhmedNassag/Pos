    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- Form -->
                <form action="{{ route('purchases.update', 'test') }}" method="post" enctype="multipart/form-data">
                    {{ method_field('patch') }}
                    @csrf
                    <div class="row">
                        <!-- date -->
                                    ...
                                    <tr>
                                        <td style="width:48%;">
                                            ...
                                            <select class="form-control select2" name="product_id[]" required>
                                                <option label="{{ trans('main.Choose') }}"></option>
                                                <option value="{{$purchase_detail->product_id}}">{{$purchase_detail->product->name}}</option>
                                            </select>
                                        </td>
                                        <td style="width:3%;"></td>
                                        <td style="width:48%;">
