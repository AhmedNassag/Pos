...
@section('css')
    @section('title')
        {{ trans('main.Reports') }} {{ trans('main.Client') }}
    @stop
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ trans('main.Reports') }} {{ trans('main.Client') }}</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                    ...
                    <div id="print">
                        <div class="card-header pb-0">
                            ...
                            <div class="d-flex justify-content-between">
                                <h4 class="card-title mg-b-0">{{ trans('main.Reports') }} {{ trans('main.Client') }}</h4>
                                        ...
                                        <div class="card  bg-success-gradient">
                                            <div class="card-body">
                                                <div class="counter-status d-flex md-mb-0">
                                                    ...
                                                    <div class="mr-auto">
                                                        <h5 class="tx-white-8 mb-3">{{ trans('main.total') }} {{ trans('main.Sales') }}</h5>
                                                        <h2 class="counter mb-0 text-white">{{ $data['total_sales'] }}</h2>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="tab-menu-heading">
                                    <div class="tabs-menu ">
                                        ...
                                        <ul class="nav panel-tabs">
                                            ...
                                            <li><a href="#tab2" data-toggle="tab"><i class="fa fa-coins"></i> {{ trans('main.payments') }} {{ trans('main.Sales') }}</a></li>
                                            <li><a href="#tab3" data-toggle="tab"><i class="fa fa-share"></i> {{ trans('main.Returns') }} {{ trans('main.Sales') }}</a></li>
                                            <li><a href="#tab4" data-toggle="tab"><i class="fa fa-hands"></i> {{ trans('main.payments') }} {{ trans('main.Returns') }} {{ trans('main.Sales') }}</a></li>
                                        </ul>
                                    </div>
                                </div>
                                        ...
                                        <div class="tab-pane" id="tab2">
                                            <div class="table-responsive hoverable-table">
                                                <table class="table table-striped" id="example1" data-page-length='50' style="text-align: center;">      
                                                    ...
                                                    <tbody>
                                                        <?php $i = 0; ?>
                                                        @foreach ($data['salesPayments'] as $item)
                                                            <?php $i++; ?>
                                                            <tr>
                                                                <td class="text-center">{{ $i }}</td>
                                                                <td class="text-center">{{ $item->date }}</td>
                                                                <td class="text-center">{{ $item->Ref }}</td>
                                                                <td class="text-center">{{ $item->Sale_Ref }}</td>
                                        ...
                                        <div class="tab-pane" id="tab3">
                                            <div class="table-responsive hoverable-table">
                                                <table class="table table-striped" id="example1" data-page-length='50' style="text-align: center;">      
                                                    ...
                                                    <tbody>
                                                        <?php $i = 0; ?>
                                                        @foreach ($data['salesReturns'] as $item)
                                                            <?php $i++; ?>
                                                            <tr>
                                                                <td class="text-center">{{ $i }}</td>
                                                                <td class="text-center">{{ $item->Ref }}</td>
                                                ...
                                                <table class="table table-striped" id="example1" data-page-length='50' style="text-align: center;">      
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="text-center border-bottom-0">{{ trans('main.Date')}}</th>
                                                            <th class="text-center border-bottom-0">{{ trans('main.Ref')}}</th>
                                                            <th class="text-center border-bottom-0">{{ trans('main.Returns') }} {{ trans('main.Sale')}}</th>
                                                            <th class="text-center border-bottom-0">{{ trans('main.Amount')}}</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        <?php $i = 0; ?>
                                                        @foreach ($data['salesReturnsPayments'] as $item)
                                                            <?php $i++; ?>
                                                            <tr>
                                                                <td class="text-center">{{ $i }}</td>
                                                                <td class="text-center">{{ $item->date }}</td>
                                                                <td class="text-center">{{ $item->Ref }}</td>
                                                                <td class="text-center">{{ $item->SaleReturn_Ref }}</td>
                                                                <td class="text-center">{{ $item->montant }}</td>
                                                            </tr>
                                                        @endforeach
                                                    </tbody>
