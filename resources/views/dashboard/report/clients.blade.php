...
@section('css')
    @section('title')
        {{ trans('main.Report') }} {{ trans('main.Clients') }}
    @stop
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ trans('main.Report') }} {{ trans('main.Clients') }}</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                    ...
                    <div id="print">
                        <div class="card-header pb-0">
                            ...
                            <div class="d-flex justify-content-between">
                                <h4 class="card-title mg-b-0">{{ trans('main.Report') }} {{ trans('main.Clients') }}</h4>
                            ...
                            <form action="{{ route('reports.clients') }}" method="get">
                                <div class="row mt-5">
                                    <div class="col-3 mr-2 notPrint">
                                        <label for="client" class="">{{ trans('main.Client') }} :</label>
                                        <select class="form-control text-center" name="client_id" placeholder="search">
                                        ...
                                        @foreach($data as $item)
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a class="btn btn-primary btn-sm" href="{{ route('reports.clientDetails',[$item['id']]) }}" title="{{ trans('main.Reports') }}">
