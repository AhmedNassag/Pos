...
@section('css')
    @section('title')
        {{ trans('main.Report') }} {{ trans('main.Sales') }}
    @stop
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ trans('main.Report') }} {{ trans('main.Sales') }}</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                    ...
                    <div id="print">
                        <div class="card-header pb-0">
                            ...
                            <div class="d-flex justify-content-between">
                                <h4 class="card-title mg-b-0">{{ trans('main.Report') }} {{ trans('main.Sales') }}</h4>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach($sales as $item)
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">{{ $item->client->phone }}</td>
