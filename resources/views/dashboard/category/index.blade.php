                            ...
                            <div class="row row-xs">
                                <div class="col-sm-6 col-md-12 notPrint">
                                    @if($trashed == false)
                                        ...
                                        @endcan
                                        @can('أرشيف الفئات')
                                            <a class="btn btn-danger ripple float-left" href="{{ route('category.archived') }}">
                                                <i class="fe fe-alert-triangle"></i>&nbsp;{{ trans('main.Archive') }} {{ trans('main.Categories') }}
                                            </a>
                                        @endcan
                                    @else
                                        @can('عرض الفئات')
                                            <a class="btn btn-danger ripple float-left" href="{{ route('category.index') }}">
