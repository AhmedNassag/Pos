...
@section('css')
    @section('title')
        {{ trans('main.Expenses Categories') }}
    @stop
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ trans('main.Expenses Categories') }}</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
...
@section('content')
        ...
        <div class="row">
                    ...
                    <div id="print">
                        <div class="card-header pb-0">
                            ...
                            <div class="d-flex justify-content-between">
                                <h4 class="card-title mg-b-0">{{ trans('main.Expenses Categories') }}</h4>
                            ...
                            <div class="row row-xs">
                                <div class="col-sm-6 col-md-12 notPrint">
                                    @if($trashed == false)
                                        ...
                                        @endcan
                                        @can('أرشيف فئات المصروفات')
                                            <a class="btn btn-danger ripple float-left" href="{{ route('expensescategory.archived') }}">
                                                <i class="fe fe-alert-triangle"></i>&nbsp;{{ trans('main.Archive') }} {{ trans('main.Expenses Categories') }}
                                            </a>
                                        @endcan
                                    @else
                                        @can('عرض فئات المصروفات')
                                            <a class="btn btn-danger ripple float-left" href="{{ route('expensescategory.index') }}">
                                                {{ trans('main.Back') }} <i class="typcn typcn-arrow-left-outline"></i>
                                            </a>
                                        @endcan
                                    @endif
                                    @can('طباعة فئات المصروفات')
                                        <button class="btn btn-dark ripple" id="print_Button" onclick="printDiv()">
                                            <i class="mdi mdi-printer"></i>&nbsp;{{ trans('main.Print') }}
                                        </button>
                                    @endcan
                                    @can('حذف فئات المصروفات')
                                ...
                                <table class="table table-striped" id="example1" data-page-length='50' style=" text-align: center;">      
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center border-bottom-0 notPrint">{{ trans('main.Description')}}</th>
                                    ...
                                    <tbody>
                                        ...
                                        @if($trashed == false)
                                            <tr class="notPrint">
                                                ...
                                                <td class="text-center"></td>
                                                <form action="{{ route('expensescategory.index') }}" method="get">
                                                    ...
                                                    <td class="text-center">
                                                        <input type="text" class="form-control text-center" name="description" placeholder="{{ trans('main.Enter Search Key Of') }} {{ trans('main.Description') }}" value="{{ $description }}">
                                                    </td>
                                                    <td class="text-center">
                                        ...
                                        @foreach ($expensescategories as $item)
                                                ...
                                                <td class="text-center notPrint">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu tx-13 bd-primary rounded-5">
                                                            @if($trashed == false)
                                                                @can('عرض فئات المصروفات')
                                                                    <a class="dropdown-item" href="{{ route('expensescategory.show',[$item->id]) }}" title="{{ trans('main.Show') }}">
                                            ...
                                            @include('dashboard.expensescategory.editModal')
                                            @include('dashboard.expensescategory.deleteModal')
                                            @include('dashboard.expensescategory.forceDeleteModal')
                                            @include('dashboard.expensescategory.restoreModal')
            ...
            @include('dashboard.expensescategory.addModal')
            @include('dashboard.expensescategory.deleteSelectedModal')
