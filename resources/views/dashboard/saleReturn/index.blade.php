...
@section('css')
    @section('title')
    {{ trans('main.Returns') }} {{ trans('main.Sales') }}
    @stop
@endsection
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ trans('main.Returns') }} {{ trans('main.Sales') }}</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
...
@section('content')
        ...
        <div class="row">
                    ...
                    <div id="print">
                        <div class="card-header pb-0">
                            ...
                            <div class="d-flex justify-content-between">
                                <h4 class="card-title mg-b-0">{{ trans('main.Returns') }} {{ trans('main.Sales') }}</h4>
                                ...
                                <div class="col-sm-6 col-md-12 notPrint">
                                    ...
                                    @else
                                        @can('عرض مرتجع المبيعات')
                                            <a class="btn btn-danger ripple float-left" href="{{ route('salesReturns.index') }}">
                                    ...
                                    <tbody>
                                        ...
                                        @if($trashed == false)
                                            <tr class="notPrint">
                                                ...
                                                <td class="text-center"></td>
                                                <form action="{{ route('salesReturns.index') }}" method="get">
                                        ...
                                        @foreach ($salesReturns as $item)
                                                ...
                                                <td class="text-center notPrint">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu tx-13 bd-primary rounded-5">
                                                            @if($trashed == false)
                                                                @can('عرض مرتجع المبيعات')
                                                                    <a class="dropdown-item" href="{{ route('salesReturns.show',[$item->id]) }}" title="{{ trans('main.Show') }}">
                                                                        <i class="text-success fas fa-eye"></i>&nbsp;&nbsp;{{ trans('main.Show') }}
                                                                    </a>
                                                                @endcan
                                                                @can('عرض دفع مرتجع المبيعات')
                                            ...
                                            @include('dashboard.saleReturn.deleteModal')
                                            @include('dashboard.saleReturn.forceDeleteModal')
                                            @include('dashboard.saleReturn.restoreModal')
                                            @include('dashboard.saleReturn.addPaymentModal')
                                            @include('dashboard.saleReturn.showPaymentsModal')
            ...
            @include('dashboard.saleReturn.addModal')
            @include('dashboard.saleReturn.deleteSelectedModal')
