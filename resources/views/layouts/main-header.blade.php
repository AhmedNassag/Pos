				...
				<div class="container-fluid">
					...
					<div class="main-header-right">
								...
								<div class="dropdown  nav-itemd-none d-md-flex">
									...
									<div class="dropdown-menu dropdown-menu-left dropdown-menu-arrow" x-placement="bottom-end">
										...
										<a href="#" class="dropdown-item d-flex ">
											...
											<div class="d-flex">
												<span class="mt-2">{{ trans('main.French') }}</span>
											</div>
										</a>
									</div>
								</div>
						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
							...
							<!-- Start Notifications -->
							@can('الإشعارات')
								<div class="dropdown nav-item main-header-notification" id="notification-div">
										...
										<div id="unreadNotifications">
											@foreach (auth()->user()->unreadNotifications as $notification)
												<div class="main-notification-list Notification-scroll">
													<a class="d-flex p-3 border-bottom" href="{{ url('/'.$notification->data['route'].'/'.$notification->id) }}">
							...
							<div class="dropdown main-profile-menu nav nav-item nav-link">
								...
								<div class="dropdown-menu">
									...
									<a class="dropdown-item" href="{{ route('settings.profile') }}"><i class="bx bx-user-circle"></i>{{ trans('main.Profile') }}</a>
									<a class="dropdown-item" href="{{ route('settings.editProfile') }}"><i class="bx bx-cog"></i>{{ trans('main.Edit Profile') }}</a>
									<a class="dropdown-item" href="{{ route('settings.changePassword') }}"><i class="bx bx-slider-alt"></i>{{ trans('main.Change Password') }}</a>
